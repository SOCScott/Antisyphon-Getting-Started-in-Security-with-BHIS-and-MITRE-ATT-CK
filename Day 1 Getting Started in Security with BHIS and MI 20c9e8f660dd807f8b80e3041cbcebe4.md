...
1. **Question**: What is the primary reason John Strand recommends against focusing solely on security tools rather than foundational skills?
...
2. **Question**: According to the training, what three directories should be included in a basic AppLocker allow listing policy?
   - **Answer:**
- Windows directory
...
3. **Question**: Why does the John Strand argue that password length is more important than complexity, and what minimum length does he recommend?
...
4. **Question**: What is Kerberoasting and why was it initially rejected by major security conferences?
